...
- If the nature of the change seems to have a visual component (which is often the case for changes to `bin/tui`), recommend including a screenshot or video to demonstrate the change, if appropriate.
