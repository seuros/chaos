...
pub(crate) fn register(url: &str) -> Color {
...
pub(crate) fn lookup(color: Color) -> Option<String> {
...
#[cfg(test)]
pub(crate) fn with_enabled<R>(val: bool, f: impl FnOnce() -> R) -> R {
