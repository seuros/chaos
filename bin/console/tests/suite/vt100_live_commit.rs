...
fn live_001_commit_on_overflow() {
    ...
    let mut term = match chaos_console::custom_terminal::Terminal::with_options(backend) {
        Ok(t) => t,
    ...
    let mut rb = chaos_console::live_wrap::RowBuilder::new(20);
    ...
    chaos_console::insert_history::insert_history_lines(&mut term, lines)
