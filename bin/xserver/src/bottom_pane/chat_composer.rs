...
//!
//! For the detailed burst state machine, see `bin/xserver/src/bottom_pane/paste_burst.rs`.
...
程序员 与 Unicode 同行";
    ...
    fn pasting_filepath_attaches_image() {
        ...
        let tmp_path: PathBuf = tmp.path().join("chaos_xserver_test_paste_image.png");
