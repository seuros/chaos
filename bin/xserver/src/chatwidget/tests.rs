...
use chaos_ipc::protocol::GuardianAssessmentEvent;
use chaos_ipc::protocol::GuardianAssessmentStatus;
use chaos_ipc::protocol::GuardianRiskLevel;
...
async fn submit_user_message_emits_structured_plugin_mentions_from_bindings() {
    ...
    chat.bottom_pane.set_plugin_mentions(Some(vec![
        chaos_kern::plugins::PluginCapabilitySummary {
    ...
    chat.handle_codex_event(Event {
        ...
        msg: EventMsg::HookStarted(chaos_ipc::protocol::HookStartedEvent {
            ...
            run: chaos_ipc::protocol::HookRunSummary {
                ...
                scope: chaos_ipc::protocol::HookScope::Thread,
