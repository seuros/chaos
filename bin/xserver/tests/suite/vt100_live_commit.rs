...
fn live_001_commit_on_overflow() {
    ...
    let mut term = match chaos_xserver::custom_terminal::Terminal::with_options(backend) {
        Ok(t) => t,
    ...
    let mut rb = chaos_xserver::live_wrap::RowBuilder::new(20);
    ...
    chaos_xserver::insert_history::insert_history_lines(&mut term, lines)
