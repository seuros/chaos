...
impl From<SandboxWorkspaceWrite> for codex_protocol::api::SandboxSettings {
...
pub struct ToolsToml {
    ...
    pub web_search: Option<codex_protocol::config_types::WebSearchToolConfig>,
...
enum WebSearchToolConfigInput {
    Enabled(bool),
    Config(codex_protocol::config_types::WebSearchToolConfig),
}

impl From<ToolsToml> for codex_protocol::api::Tools {
...
fn deserialize_optional_web_search_tool_config<'de, D>(
    deserializer: D,
) -> Result<Option<codex_protocol::config_types::WebSearchToolConfig>, D::Error>
where
    D: Deserializer<'de>,
{
...
pub struct ProjectConfig {
    pub trust_level: Option<codex_protocol::config_types::TrustLevel>,
}
