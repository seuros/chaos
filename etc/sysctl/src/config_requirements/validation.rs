...
#[cfg(test)]
mod tests {
    use super::super::conversion::ConfigRequirementsToml;
    use super::super::sourced::ConfigRequirementsWithSources;
    use super::super::sourced::Sourced;
    ...
    use super::super::types::ResidencyRequirement;
    use super::super::types::SandboxModeRequirement;
    use super::super::types::WebSearchModeRequirement;
    use super::merge_enablement_settings_descending;
    use anyhow::Result;
    use chaos_ipc::config_types::WebSearchMode;
