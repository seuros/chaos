...
pub use chaos_ipc::config_types::Personality;
...
impl From<SandboxWorkspaceWrite> for chaos_ipc::api::SandboxSettings {
...
pub struct ToolsToml {
    ...
    pub web_search: Option<chaos_ipc::config_types::WebSearchToolConfig>,
...
enum WebSearchToolConfigInput {
    Enabled(bool),
    Config(chaos_ipc::config_types::WebSearchToolConfig),
}

impl From<ToolsToml> for chaos_ipc::api::Tools {
...
fn deserialize_optional_web_search_tool_config<'de, D>(
    deserializer: D,
) -> Result<Option<chaos_ipc::config_types::WebSearchToolConfig>, D::Error>
where
    D: Deserializer<'de>,
{
...
pub struct AgentsToml {
    ...
    /// Default maximum runtime in seconds for child agent job tasks.
    #[schemars(range(min = 1))]
