pub(crate) const OTEL_TARGET_PREFIX: &str = "chaos_snitch";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "chaos_snitch.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "chaos_snitch.trace_safe";
