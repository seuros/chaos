...
use super::domain::{
    ANSWER_PLACEHOLDER, APPROVAL_ACCEPT_ALWAYS_VALUE, APPROVAL_ACCEPT_ONCE_VALUE,
    APPROVAL_ACCEPT_SESSION_VALUE, APPROVAL_CANCEL_VALUE, APPROVAL_DECLINE_VALUE,
    APPROVAL_PERSIST_ALWAYS_VALUE, APPROVAL_PERSIST_KEY, APPROVAL_PERSIST_SESSION_VALUE,
    ComposerDraft, MIN_COMPOSER_HEIGHT, MIN_OVERLAY_HEIGHT, McpServerElicitationAnswerState,
    McpServerElicitationField, McpServerElicitationFieldInput, McpServerElicitationFormRequest,
    McpServerElicitationResponseMode, OPTIONAL_ANSWER_PLACEHOLDER,
};
use super::formatting::format_tool_approval_display_message;
use super::support::{FooterTip, wrap_footer_tips};

const FOOTER_SEPARATOR: &str = super::domain::FOOTER_SEPARATOR;
...
impl McpServerElicitationOverlay {
    ...
    fn current_options(&self) -> &[super::domain::McpServerElicitationOption] {
