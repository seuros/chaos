...
use super::super::core::PendingSteerCompareKey;
use super::super::core::RateLimitErrorKind;
use super::super::core::RenderedUserMessageEvent;
use super::super::core::ReplayKind;
use super::super::core::UnifiedExecProcessSummary;
use super::super::core::UnifiedExecWaitStreak;
#[cfg(test)]
use super::super::core::append_text_with_rebased_elements;
use super::super::core::hook_event_label;
use super::super::core::is_standard_tool_call;
use super::super::core::is_unified_exec_source;
use super::super::core::merge_user_messages;
use super::super::core::rate_limit_error_kind;
...
impl ChatWidget {
    ...
    pub(crate) fn on_interrupted_turn(&mut self, reason: TurnAbortReason) {
        ...
        if send_pending_steers_immediately {
            let pending_steers: Vec<super::super::core::UserMessage> = self
                .pending_steers
                .drain(..)
