...
use utils::{
    ...
    LIGHT_TC_GUTTER_FG_RGB, TAB_WIDTH, diff_color_level_for_terminal, fallback_diff_backgrounds,
    resolve_diff_backgrounds_for, style_add, style_del, style_gutter_dim, style_gutter_for,
    style_line_bg_for, style_sign_add, style_sign_del,
};
...
fn snapshot_lines(name: &str, lines: Vec<ratatui::text::Line<'static>>, width: u16, height: u16) {
    assert_snapshot!(
        name,
