...
pub struct AgentPickerProcessEntry {
    /// Human-friendly nickname shown in picker rows and footer labels.
    pub agent_nickname: Option<String>,
    /// Agent type shown in brackets when present, for example `task`.
...
pub fn previous_agent_shortcut() -> crate::key_hint::KeyBinding {
    crate::key_hint::alt(KeyCode::Left)
}

pub fn next_agent_shortcut() -> crate::key_hint::KeyBinding {
