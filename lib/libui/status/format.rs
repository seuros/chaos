...
impl FieldFormatter {
    ...
    pub fn line(&self, label: &'static str, value_spans: Vec<Span<'static>>) -> Line<'static> {
    ...
    pub fn value_width(&self, available_inner_width: usize) -> usize {
...
pub fn push_label(labels: &mut Vec<String>, seen: &mut BTreeSet<String>, label: &str) {
