...
use rama::tls::rustls::dep::rcgen::BasicConstraints;
use rama::tls::rustls::dep::rcgen::CertificateParams;
use rama::tls::rustls::dep::rcgen::DistinguishedName;
use rama::tls::rustls::dep::rcgen::DnType;
use rama::tls::rustls::dep::rcgen::ExtendedKeyUsagePurpose;
use rama::tls::rustls::dep::rcgen::IsCa;
use rama::tls::rustls::dep::rcgen::Issuer;
use rama::tls::rustls::dep::rcgen::KeyPair;
use rama::tls::rustls::dep::rcgen::KeyUsagePurpose;
use rama::tls::rustls::dep::rcgen::PKCS_ECDSA_P256_SHA256;
use rama::tls::rustls::dep::rcgen::SanType;
...
fn managed_ca_paths() -> Result<(PathBuf, PathBuf)> {
    let chaos_home =
        find_chaos_home().context("failed to resolve CODEX_HOME for managed MITM CA")?;
    let proxy_dir = chaos_home.join(MANAGED_MITM_CA_DIR);
    Ok((
