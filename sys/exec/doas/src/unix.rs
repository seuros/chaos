...
//! `EscalateRequest` over the inherited `CHAOS_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `CHAOS_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use chaos_ipc::approvals::EscalationPermissions;
pub use chaos_ipc::approvals::Permissions;
