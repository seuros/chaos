...
pub(super) async fn spawn_review_thread(
    ...
    let turn_metadata_state = Arc::new(TurnMetadataState::new(
        ...
        &parent_turn_context.vfs_policy,
    ));
    ...
    let review_turn_context = TurnContext {
        ...
        mode_id: parent_turn_context.mode_id.clone(),
        mode_capabilities: parent_turn_context.mode_capabilities,
        mode_policy: parent_turn_context.mode_policy.clone(),
        personality: parent_turn_context.personality,
        approval_policy: parent_turn_context.approval_policy.clone(),
        vfs_policy: parent_turn_context.vfs_policy.clone(),
        socket_policy: parent_turn_context.socket_policy,
        network: parent_turn_context.network.clone(),
        shell_environment_policy: parent_turn_context.shell_environment_policy.clone(),
        cwd: parent_turn_context.cwd.clone(),
        final_output_json_schema: None,
        alcatraz_exe: parent_turn_context.alcatraz_exe.clone(),
