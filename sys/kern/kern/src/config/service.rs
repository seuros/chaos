...
use chaos_ipc::api::Config as ApiConfig;
use chaos_ipc::api::ConfigBatchWriteParams;
use chaos_ipc::api::ConfigLayerMetadata;
use chaos_ipc::api::ConfigLayerSource;
use chaos_ipc::api::ConfigReadParams;
use chaos_ipc::api::ConfigReadResponse;
use chaos_ipc::api::ConfigValueWriteParams;
use chaos_ipc::api::ConfigWriteErrorCode;
use chaos_ipc::api::ConfigWriteResponse;
use chaos_ipc::api::MergeStrategy;
use chaos_ipc::api::OverriddenMetadata;
use chaos_ipc::api::WriteStatus;
...
impl ConfigService {
    ...
    pub fn new_with_defaults(chaos_home: PathBuf) -> Self {
        Self {
            chaos_home,
    ...
    /// include any in-repo .chaos/ folders because there is no cwd/project root
