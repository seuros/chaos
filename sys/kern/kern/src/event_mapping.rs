...
use chaos_ipc::items::ReasoningItem;
...
use chaos_ipc::models::is_image_close_tag_text;
use chaos_ipc::models::is_image_open_tag_text;
use chaos_ipc::models::is_local_image_close_tag_text;
use chaos_ipc::models::is_local_image_open_tag_text;
...
pub fn parse_turn_item(item: &ResponseItem) -> Option<TurnItem> {
    match item {
        ...
        ResponseItem::ImageGenerationCall {
            ...
            chaos_ipc::items::ImageGenerationItem {
                id: id.clone(),
                status: status.clone(),
