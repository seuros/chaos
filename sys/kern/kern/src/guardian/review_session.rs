...
impl GuardianReviewSessionReuseKey {
    fn from_spawn_config(spawn_config: &Config) -> Self {
        Self {
            ...
            alcatraz_linux_exe: spawn_config.alcatraz_linux_exe.clone(),
            alcatraz_freebsd_exe: spawn_config.alcatraz_freebsd_exe.clone(),
...
pub(crate) fn build_guardian_review_session_config(
    ...
    live_network_config: Option<chaos_pf::NetworkProxyConfig>,
    active_model: &str,
