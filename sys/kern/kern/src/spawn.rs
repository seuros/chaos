...
pub const CHAOS_SANDBOX_NETWORK_DISABLED_ENV_VAR: &str = "CHAOS_SANDBOX_NETWORK_DISABLED";
...
pub const CHAOS_SANDBOX_ENV_VAR: &str = "CHAOS_SANDBOX";
    ...
    unsafe {
        ...
        cmd.pre_exec(move || {
            ...
            #[cfg(target_os = "linux")]
            {
                ...
                // current parent dies."
                chaos_pty::process_group::set_parent_death_signal(parent_pid)?;
            }
            Ok(())
        });
    }
