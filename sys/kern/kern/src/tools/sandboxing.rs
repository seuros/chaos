...
pub(crate) enum ExecApprovalRequirement {
    ...
    Skip {
        ...
        /// Only applies if the command fails to run in sandbox and chaos prompts the user to run outside the sandbox.
    ...
    pub fn env_for(
        ...
        self.manager
            .transform(crate::sandboxing::SandboxTransformRequest {
                ...
                alcatraz_exe: self.alcatraz_exe,
            })
    }
}
