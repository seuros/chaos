...
fn test_build_specs_collab_tools_enabled() {
    ...
    assert_lacks_tool_name(&tools, "spawn_child_agents_on_csv");
...
#[test]
fn test_build_specs_child_agent_jobs_allowed_enables_child_agent_jobs_and_collab_tools() {
    let config = test_config();
    let model_info = ModelsManager::construct_model_info_offline_for_tests("gpt-5-codex", &config);
...
#[test]
fn test_build_specs_child_agent_job_worker_tools_enabled() {
    let config = test_config();
    let model_info = ModelsManager::construct_model_info_offline_for_tests("gpt-5-codex", &config);
    ...
    let tools_config = ToolsConfig::new(&ToolsConfigParams {
        ...
        session_source: SessionSource::SubAgent(SubAgentSource::Other(
            "child_agent_job:test".to_string(),
        )),
        vfs_policy: &VfsPolicy::unrestricted(),
        collab_enabled: true,
    });
