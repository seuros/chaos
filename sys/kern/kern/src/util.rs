...
///
/// This logs a tracing event with `target: "feedback_tags"`.
///
...
///
/// ```rust
/// chaos_kern::feedback_tags!(model = "gpt-5", cached = true);
/// chaos_kern::feedback_tags!(provider = provider_id, request_id = request_id);
/// ```
#[macro_export]
