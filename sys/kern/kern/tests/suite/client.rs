...
use chaos_ipc::models::LocalShellExecAction;
use chaos_ipc::models::LocalShellStatus;
...
async fn resume_includes_initial_messages_and_sends_prior_items() {
    ...
    let prior_user = chaos_ipc::models::ResponseItem::Message {
        id: None,
        role: "user".to_string(),
    ...
    let prior_system = chaos_ipc::models::ResponseItem::Message {
        id: None,
        role: "system".to_string(),
        content: vec![chaos_ipc::models::ContentItem::OutputText {
    ...
    let prior_item = chaos_ipc::models::ResponseItem::Message {
        id: None,
...
async fn prefers_apikey_when_config_prefers_apikey_even_with_chatgpt_tokens() {
    ...
    let auth_manager =
        match CodexAuth::from_auth_storage(codex_home.path(), AuthCredentialsStoreMode::File) {
            Ok(Some(auth)) => chaos_kern::test_support::auth_manager_from_auth(auth),
