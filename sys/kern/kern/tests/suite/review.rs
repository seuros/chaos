...
use chaos_ipc::protocol::ReviewCodeLocation;
use chaos_ipc::protocol::ReviewFinding;
use chaos_ipc::protocol::ReviewLineRange;
...
async fn review_input_isolated_from_parent_history() {
    ...
    let session_file = codex_home.path().join("resume.jsonl");
    {
        ...
        let user = chaos_ipc::models::ResponseItem::Message {
            id: None,
            role: "user".to_string(),
        ...
        let assistant = chaos_ipc::models::ResponseItem::Message {
            id: None,
